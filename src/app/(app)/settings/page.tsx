  ...
  return (
    <div className="max-w-[680px] w-full mx-auto p-6 md:p-10 animate-in fade-in slide-in-from-bottom-4">
      ...
      <div className="mb-7">
        ...
        <p className="text-[13px] text-[#8B6F5E]">บัญชีและการตั้งค่า</p>
      </div>

      {/* ── PROFILE CARD ── */}
      <div className="relative bg-white border border-[#D9D2C7] rounded-[12px] p-6 mb-4 shadow-sm flex items-center gap-[18px]">
        
        {/* แค่เรียกใช้ตรงๆ เลย ปุ่มจะเด้งมาโชว์ที่มุมขวาบนเองอัตโนมัติ! */}
      ...
      <div className="flex flex-col gap-2 mb-4">
         <GoalModal initialTarget={goal?.targetBooks || 0}>
            <button className="w-full text-left bg-white border border-[#D9D2C7] rounded-[10px] p-[16px_18px] flex items-center justify-between cursor-pointer transition-all hover:border-[#C4A882] hover:bg-[#EDE8DF]/30 shadow-sm outline-none group">
              <div className="flex items-center gap-[14px]">
                 <div className="w-[36px] h-[36px] rounded-lg bg-[#EDE8DF] flex items-center justify-center text-[#8B6F5E] shrink-0 group-hover:text-[#C07B5A] transition-colors">
              ...
              <svg className="text-[#8B6F5E] group-hover:text-[#C07B5A] transition-colors" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="9 18 15 12 9 6"/></svg>
            </button>
         </GoalModal>
      </div>
